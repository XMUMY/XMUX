...
class XmuxVotingV1VotingApi {
  ...
  XmuxVotingV1VotingApi([ApiClient apiClient]) : apiClient = apiClient ?? defaultApiClient;

  /// /v3/voting/addAct
  ///
  /// 
  Future<InlineResponse200> v3VotingAddActPost(XmuxVotingV1AddActReq body) async {
  ...
  ///
  /// 
  Future<InlineResponse2001> v3VotingAddEventPost(XmuxVotingV1AddEventReq body) async {
    Object postBody = body;
  ...
  ///
  /// 
  Future<InlineResponse2002> v3VotingGetActPost(XmuxVotingV1GetActReq body) async {
    Object postBody = body;
  ...
  ///
  /// 
  Future<InlineResponse2003> v3VotingModifyEventPost(XmuxVotingV1ModifyEventReq body) async {
    Object postBody = body;
  ...
  ///
  /// 
  Future<InlineResponse2004> v3VotingRemoveEventPost(XmuxVotingV1RemoveEventReq body) async {
    Object postBody = body;
  ...
  ///
  /// 
  Future<InlineResponse2006> v3VotingVotedEventPost(XmuxVotingV1VotedEvReq body) async {
    Object postBody = body;
  ...
  ///
  /// 
  Future<InlineResponse2007> v3VotingVotesGet({ String activity, int beg, int amount }) async {
