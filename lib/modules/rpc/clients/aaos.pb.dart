...
class Info extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Info', package: const $pb.PackageName('xmux.core.aaos.v4'), createEmptyInstance: create)
    ..aOS(1, 'name')
    ..e<Info_Gender>(2, 'gender', $pb.PbFieldType.OE, defaultOrMaker: Info_Gender.male, valueOf: Info_Gender.valueOf, enumValues: Info_Gender.values)
    ..aOS(3, 'id')
    ..aOS(4, 'programme')
  ...
  @$pb.TagNumber(2)
  set gender(Info_Gender v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class Timetable_Class extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Timetable.Class', package: const $pb.PackageName('xmux.core.aaos.v4'), createEmptyInstance: create)
    ..aOS(1, 'cid')
    ..aOS(2, 'name')
    ..aOS(3, 'lecturer')
    ..aOS(4, 'room')
  ...
  Timetable_Class copyWith(void Function(Timetable_Class) updates) => super.copyWith((message) => updates(message as Timetable_Class));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Timetable extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Timetable', package: const $pb.PackageName('xmux.core.aaos.v4'), createEmptyInstance: create)
    ..pc<Timetable_Class>(1, 'classes', $pb.PbFieldType.PM, subBuilder: Timetable_Class.create)
    ..hasRequiredFields = false
  ;
  ...
  Timetable copyWith(void Function(Timetable) updates) => super.copyWith((message) => updates(message as Timetable));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Courses_Course extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Courses.Course', package: const $pb.PackageName('xmux.core.aaos.v4'), createEmptyInstance: create)
    ..aOS(1, 'name')
  ...
  Courses_Course copyWith(void Function(Courses_Course) updates) => super.copyWith((message) => updates(message as Courses_Course));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Courses extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Courses', package: const $pb.PackageName('xmux.core.aaos.v4'), createEmptyInstance: create)
    ..pc<Courses_Course>(1, 'courses', $pb.PbFieldType.PM, subBuilder: Courses_Course.create)
    ..hasRequiredFields = false
  ;
  ...
  Courses copyWith(void Function(Courses) updates) => super.copyWith((message) => updates(message as Courses));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Exams_Exam extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Exams.Exam', package: const $pb.PackageName('xmux.core.aaos.v4'), createEmptyInstance: create)
    ..aOS(1, 'exam')
  ...
  Exams_Exam copyWith(void Function(Exams_Exam) updates) => super.copyWith((message) => updates(message as Exams_Exam));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Exams extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Exams', package: const $pb.PackageName('xmux.core.aaos.v4'), createEmptyInstance: create)
    ..pc<Exams_Exam>(1, 'exams', $pb.PbFieldType.PM, subBuilder: Exams_Exam.create)
    ..hasRequiredFields = false
  ;
  ...
  Exams copyWith(void Function(Exams) updates) => super.copyWith((message) => updates(message as Exams));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Transcript_Session_Course extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Transcript.Session.Course', package: const $pb.PackageName('xmux.core.aaos.v4'), createEmptyInstance: create)
    ..aOS(1, 'code')
    ..aOS(2, 'name')
  ...
  Transcript_Session_Course copyWith(void Function(Transcript_Session_Course) updates) => super.copyWith((message) => updates(message as Transcript_Session_Course));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Transcript_Session extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Transcript.Session', package: const $pb.PackageName('xmux.core.aaos.v4'), createEmptyInstance: create)
    ..aOS(1, 'session')
    ..pc<Transcript_Session_Course>(2, 'courses', $pb.PbFieldType.PM, subBuilder: Transcript_Session_Course.create)
  ...
  Transcript_Session copyWith(void Function(Transcript_Session) updates) => super.copyWith((message) => updates(message as Transcript_Session));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Transcript extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Transcript', package: const $pb.PackageName('xmux.core.aaos.v4'), createEmptyInstance: create)
    ..pc<Transcript_Session>(1, 'sessions', $pb.PbFieldType.PM, subBuilder: Transcript_Session.create)
    ..hasRequiredFields = false
  ;
