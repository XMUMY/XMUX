...
class RegisterReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RegisterReq', package: const $pb.PackageName('xmux.core.user.v4'), createEmptyInstance: create)
...
class LoginResp extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('LoginResp', package: const $pb.PackageName('xmux.core.user.v4'), createEmptyInstance: create)
...
class GetProfileReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetProfileReq', package: const $pb.PackageName('xmux.core.user.v4'), createEmptyInstance: create)
    ..aOS(1, 'uid')
    ..hasRequiredFields = false
  ;
  ...
  factory GetProfileReq.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  GetProfileReq clone() => GetProfileReq()..mergeFromMessage(this);
  GetProfileReq copyWith(void Function(GetProfileReq) updates) => super.copyWith((message) => updates(message as GetProfileReq));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class Profile extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('Profile', package: const $pb.PackageName('xmux.core.user.v4'), createEmptyInstance: create)
    ..aOS(1, 'uid')
    ..aOS(2, 'email')
...
class RefreshDeviceReq extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('RefreshDeviceReq', package: const $pb.PackageName('xmux.core.user.v4'), createEmptyInstance: create)
    ..aOS(1, 'deviceId', protoName: 'deviceId')
    ..aOS(2, 'deviceModel', protoName: 'deviceModel')
    ..aOS(3, 'deviceName', protoName: 'deviceName')
    ..e<RefreshDeviceReq_PushChannelType>(4, 'pushChannel', $pb.PbFieldType.OE, protoName: 'pushChannel', defaultOrMaker: RefreshDeviceReq_PushChannelType.fcm, valueOf: RefreshDeviceReq_PushChannelType.valueOf, enumValues: RefreshDeviceReq_PushChannelType.values)
  ...
  factory RefreshDeviceReq.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  RefreshDeviceReq clone() => RefreshDeviceReq()..mergeFromMessage(this);
  RefreshDeviceReq copyWith(void Function(RefreshDeviceReq) updates) => super.copyWith((message) => updates(message as RefreshDeviceReq));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GetDevicesResp_Device extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetDevicesResp.Device', package: const $pb.PackageName('xmux.core.user.v4'), createEmptyInstance: create)
    ..aOS(1, 'deviceId', protoName: 'deviceId')
    ..aOS(2, 'deviceModel', protoName: 'deviceModel')
    ..aOS(3, 'deviceName', protoName: 'deviceName')
    ..aOM<$2.Timestamp>(4, 'lastSeen', protoName: 'lastSeen', subBuilder: $2.Timestamp.create)
    ..hasRequiredFields = false
  ;
  ...
  factory GetDevicesResp_Device.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  GetDevicesResp_Device clone() => GetDevicesResp_Device()..mergeFromMessage(this);
  GetDevicesResp_Device copyWith(void Function(GetDevicesResp_Device) updates) => super.copyWith((message) => updates(message as GetDevicesResp_Device));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
...
class GetDevicesResp extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo('GetDevicesResp', package: const $pb.PackageName('xmux.core.user.v4'), createEmptyInstance: create)
    ..pc<GetDevicesResp_Device>(1, 'devices', $pb.PbFieldType.PM, subBuilder: GetDevicesResp_Device.create)
    ..hasRequiredFields = false
  ;
  ...
  factory GetDevicesResp.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  GetDevicesResp clone() => GetDevicesResp()..mergeFromMessage(this);
  GetDevicesResp copyWith(void Function(GetDevicesResp) updates) => super.copyWith((message) => updates(message as GetDevicesResp));
  $pb.BuilderInfo get info_ => _i;
  @$core.pragma('dart2js:noInline')
