const Map<String, String> zh_CN = {
  ...
  'Campus/AcademicTools/ExamResult/Caption': '查询您的考试成绩',
  ...
  'Campus/AcademicTools/WolframEngine/Caption': '利用强大的 Wolfram 引擎进行搜索',
  ...
  'Campus/AcademicTools/GeoGebra/Caption': '使用 GeoGebra 进行数学解算和绘图',
  ...
  'Campus/Tools/Maintenance/FormPage': '新表单',
  'Campus/Tools/Maintenance/MyComplaint': '报修记录', 
  'Campus/Tools/Maintenance/Retry': '重试', 
  'Campus/Tools/Maintenance/Details': '详情', 
  'Campus/Tools/Maintenance/ChooseEmptyError': '请选择一项', 
  'Campus/Tools/Maintenance/FormEmptyError': '请填写', 
  'Campus/Tools/Maintenance/RoomUsage': '房间用途', 
  'Campus/Tools/Maintenance/ProblemCategory': '问题类别', 
  'Campus/Tools/Maintenance/Block': '区域', 
  'Campus/Tools/Maintenance/Wing': '侧翼', 
  'Campus/Tools/Maintenance/RoomNo': '房间号', 
  'Campus/Tools/Maintenance/PhoneNo': '电话号码', 
  'Campus/Tools/Maintenance/Description': '问题描述', 
  'Campus/Tools/Maintenance/DescriptionHint': '请描述遇到的问题（须在一百字以内）',
  'Campus/Tools/Maintenance/Recurring': '重复出现的问题', 
  'Campus/Tools/Maintenance/SubmissionSuccess': '成功提交表单', 
  'Campus/Tools/Maintenance/SubmitBtn': '提交', 
